...
public class Register {
    ...
    @Step("I set register endpoint url") //menetapkan URL endpoint register
    public String setGetEndpoint2(){ // mendapatkan URL endpoint register yang sudah ditetapkan sebelumnya dan mengembalikannya sebagai String.
        return url;
    }
    @Step("I send POST HTTP request with empty body") //anotasi pelaporan langkah pengujian saat mengirimkan permintaan
    ...
    @Step("I failed register with status code 400") // metode untuk memeriksa respon HTTP dari permintaan POST yang sudah dikirimkan. Dalam hal ini, menggunakan restAssuredThat
