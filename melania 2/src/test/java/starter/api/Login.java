...
public class Login {
    ...
    public void sendLogPostHTTPrequest(){
        ...
        body.put("email","melania@gmail.com");
        body.put("password","@Melania21");
    ...
    public void sendLogPostHTTPrequest4(){
        JSONObject body = new JSONObject();
        body.put("email","melani@mail.com");
        body.put("password","");
    ...
    public void sendLogPostHTTPrequest5(){
        JSONObject body = new JSONObject();
        body.put("email","melania22a@mail.com");
        body.put("password","123123");
    ...
    public void sendLogPostHTTPrequest9(){
        JSONObject body = new JSONObject();
        body.put("email","melania@mail.com");
        body.put("password","123123");
